            ...
            <div className="flex-1">
                ...
                <div className='p-7 flex flex-wrap gap-4'>
                    {!loading && listings.length ===0 && (
                        <p classname='text-xl text-slate-700'>No Listing Found Here!</p>
                    )}
                    ...
                    {
                        showMore && (
                           <button className='text-green-700 hover:underline p-7 w-full' onClick={
                            onShowMoreClick}> Show more </button>
                        )
                    }
