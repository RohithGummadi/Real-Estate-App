...
export default function Profile() {
  ...
  const[showListingErr, setShowListingError] = useState(false);
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <p className="text-sm self-center">
          {fileUploadError ? (
            <span className="text-red-700">
              Error Image Upload  (Image should be less than 10MB)
            </span>
          ) : (
        ...
        <input type="text" placeholder="username" id="username" defaultValue ={currentUser.email} className='border p-3 rounded-lg' onChange={handleChange}/>
      ...
      <p className="text-green-700 mt-5">{showListingErr? "Error show listing": ""}</p>
